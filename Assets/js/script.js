//STILL TODO - GET RANDOM.ORG TO WORK INSTEAD OF MATH.RANDOM
const RANDOM_API_KEY = "3cffdaf3-b80e-42d2-acde-6900ec5086c2"
...
function rollDice(e){
e.preventDefault()
const unsplitDiceArrays = diceRaw(inputString.value) // 3d6, 3d6, 3d6
